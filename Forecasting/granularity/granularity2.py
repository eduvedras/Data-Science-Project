...
plot_series(data, x_label='timestamp', title='ASHRAE')
plt.gca().legend(('PRECTOT','PS','T2M','T2MDEW','T2MWET','TS','QV2M'))
xticks(rotation = 45)
show()
savefig("imagesD2/test1.png")
...
plt.gca().legend(('PRECTOT','PS','T2M','T2MDEW','T2MWET','TS','QV2M'))
show()
savefig("imagesD2/quarterly.png")
